		...
		<div id="container">
			...
			<div id="rtCol" class="grid_4">
				...
				$("#tweets").tweetable({
		            ...
		            username: '{text:Twitter Username}',
		            time: true,
		            callback : function ($this,data){if (typeof(rtColScroll) !== "undefined"){var api = rtColScroll.data('jsp');api.reinitialise();}}
		        })
				</script>
	 			{/block:ifTwitterUsername}
			...
			<div id="nextPrevButtons" class="grid_12">
				...
				<div class="pageInfo">
					<ul id="footerNav" class="clearfix">
						<li id="footerNavHome"><a href="/" title="{lang:Home}">{lang:Home}</a></li>
